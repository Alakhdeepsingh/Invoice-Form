    ...
    return (
        <div style={{ background: "#f5f5f5" }}>
            ...
            <div className="container">
                <div style={{ display: "flex", alignItems: "flexStart", justifyContent: "center", width: "auto" }}>
                    ...
                    <Form className="form-section">
                        <div className="section-card">
                            ...
                            <div className="field">
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: "5px", alignItems: "flexStart" }}>
                        ...
                        <div className="section-card">
                            <div style={{ display: "flex", alignItems: "flexStart", gap: "10px", flexDirection: "column" }}>
                            ...
                            <div className='invoice-help'>Invoice Details</div>
                            <div className="sub-section-card">

                                <div className="field">
                                    <label>Invoice Number&nbsp;<span style={{ color: "red" }}>*</span></label>
                                    <Field as="select" name="invoiceNumber" className="input">
                                ...
                                <div className="field" style={{ position: "relative" }}>
                                    ...
                                    <Field
                                        ...
                                        type="number"
                                        className="input"
                                        style={{ paddingLeft: "30px" }} // Ensure input text doesn't overlap the dollar sign
                                    />
                                </div>
                            ...
                            <div className="field">
                                ...
                                <Field name="invoiceDescription" className="input-new" style={{ height: "25px" }} />
                            </div>
                        </div>
                        ...
                        <div className="section-card">
                            ...
                            <div className="field">
                                ...
                                <div className='expanse-coding'>
                                    <button className='expanse-coding-btn'>+ Add Expanse Coding</button>
                                </div>
